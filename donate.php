<?php
	...
	{
		$conn=mysqli_connect("localhost:3308","root","","donate");
		...
		if($query_run)
		{
			...
			echo "success";
			$con=mysqli_connect("localhost:3308","root","","bg");
			$bg=$_POST['bg'];
		...
		else
		{
			...
			echo "<script>alert('Donar Enrollement unsuccessful!!!');</script>";
...
.donate{
	...
	<body>
		...
		<div class="centerdiv">
	<table class="tabledec" align="center"   width="500px;">
	<form method="POST"  >
